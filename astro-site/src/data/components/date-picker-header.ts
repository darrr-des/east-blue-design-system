...
export const datePickerHeader: ComponentData = {
  ...
  "overview": {
    ...
    "livePreviewHtml": "<div class=\"demo-layout\"><div class=\"demo-preview\" id=\"dph-demo-preview\"><span class=\"eb-preview-dpwk\">Su</span></div><div class=\"demo-figma-panel\"><div class=\"demo-panel-section\"><div class=\"demo-panel-heading\">Content</div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">#text</span><select id=\"dph-ctrl-day\" class=\"demo-panel-select\" onchange=\"_dphUpdate()\"><option value=\"Su\" selected=\"\">Su</option><option value=\"M\">M</option><option value=\"T\">T</option><option value=\"W\">W</option><option value=\"Th\">Th</option><option value=\"F\">F</option><option value=\"Sa\">Sa</option></select></div></div><div class=\"demo-panel-section\"><div class=\"demo-panel-heading\">Notes</div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">Versions</span><span class=\"demo-panel-label\">none</span></div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">Size</span><span class=\"demo-panel-label\">32 × 32</span></div></div></div></div>",
    "traits": [
      {
        "name": "Reusable",
        "rating": "pass",
