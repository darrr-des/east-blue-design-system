    ...
    "installation": {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "code": "<span class=\"syn-fn\">implementation</span><span class=\"syn-punc\">(</span><span class=\"syn-str\">\"com.eastblue.ds:carousel-card:2.1.1\"</span><span class=\"syn-punc\">)</span>"
        },
        {
          "label": "Import",
  ...
  "changelog": [
    {
      ...
      "rows": [
        {
          "body": "<strong>The Kotlin import named the component, not its family.</strong> It read <code>com.eastblue.ds.carouselcard.*</code>. Under the packaging rule settled on 2 September the package is the family — <code>Carousel</code> — so it is <code>com.eastblue.ds.carousel.*</code>. One package per family keeps imports stable when a family gains a component. The Gradle artifact keeps the slug and is unchanged.",
