...
export const horizontalVoucher: ComponentData = {
  "meta": {
    ...
    "verdict": {
      "kind": "consolidate",
      "title": "Replaced by Voucher Card Horizontal",
      "text": "This component is consolidated into <a href=\"/components/voucher-card-horizontal\"><code>Voucher Card Horizontal</code></a> — the canonical sibling. Use <code>Voucher Card</code> with <code>orientation: horizontal</code> and the <code>state</code> axis instead. Once Figma usages migrate, this record will be deleted."
    }
  },
  "overview": {
    "traits": [
