...
export const datePickerCalendar: ComponentData = {
  ...
  "overview": {
    ...
    "livePreviewHtml": "<div class=\"demo-layout\"><div class=\"demo-preview\" id=\"dpcal-demo-preview\"></div><div class=\"demo-figma-panel\"><div class=\"demo-panel-section\"><div class=\"demo-panel-heading\">Properties</div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">Mode</span><select id=\"dpcal-ctrl-mode\" class=\"demo-panel-select\" onchange=\"_dpcalUpdate()\"><option value=\"day\" selected=\"\">Day</option><option value=\"month\">Month</option><option value=\"year\">Year</option></select></div></div><div class=\"demo-panel-section\"><div class=\"demo-panel-heading\">Composed from</div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">Cells</span><span class=\"demo-panel-label\" id=\"dpcal-info-cells\">42</span></div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">Header</span><span class=\"demo-panel-label\" id=\"dpcal-info-header\">2 triggers</span></div></div></div></div>",
    "traits": [
      {
        "name": "Reusable",
        "rating": "pass",
