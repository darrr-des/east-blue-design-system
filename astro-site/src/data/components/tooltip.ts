...
export const tooltip: ComponentData = {
    ...
    "overview": {
      ...
      "livePreviewHtml": "<div class=\"demo-layout\"><div class=\"demo-preview\" id=\"tt-demo-preview\"><svg width=\"336\" height=\"134\" viewBox=\"0 0 336 134\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\"><rect x=\"0.5\" y=\"12.5\" width=\"335\" height=\"121\" rx=\"6\" fill=\"#FFFFFF\" stroke=\"#E5EBF4\"/><g transform=\"translate(0, 0)\"><g transform=\"translate(15, 0)\"><path d=\"M15.08 2.81459C13.6929 1.30131 11.3071 1.3013 9.91996 2.81459L1.5 12L23.5 12L15.08 2.81459Z\" fill=\"#FFFFFF\"/><path d=\"M0.5 11.5H2.05464C2.33812 11.5 2.60829 11.3797 2.79793 11.169L10.831 2.24329C11.2569 1.77017 11.8635 1.5 12.5 1.5C13.1365 1.5 13.7431 1.77017 14.169 2.24329L22.2021 11.169C22.3917 11.3797 22.6619 11.5 22.9454 11.5H24.5\" stroke=\"#E5EBF4\" stroke-linecap=\"round\" stroke-linejoin=\"round\" fill=\"none\"/></g></g><rect x=\"16\" y=\"28\" width=\"46\" height=\"46\" rx=\"23\" fill=\"#F6F9FD\" stroke=\"#E5EBF4\" stroke-dasharray=\"3 3\"/><text x=\"74\" y=\"45.5\" fill=\"#0A2757\" font-size=\"18\" font-weight=\"700\" letter-spacing=\"0.25\" font-family=\"'Proxima Soft', system-ui, sans-serif\">Header</text><text x=\"74\" y=\"68.5\" fill=\"#6780A9\" fill-opacity=\"1\" font-size=\"12\" font-weight=\"600\" font-family=\"'BarkAda', system-ui, sans-serif\">Description goes here</text><g stroke=\"#0A2757\" stroke-width=\"1.6\" stroke-linecap=\"round\"><line x1=\"307.5\" y1=\"31.5\" x2=\"316.5\" y2=\"40.5\"/><line x1=\"316.5\" y1=\"31.5\" x2=\"307.5\" y2=\"40.5\"/></g><rect x=\"258\" y=\"90\" width=\"59\" height=\"28\" rx=\"99\" fill=\"#005CE5\"/><text x=\"287.5\" y=\"109\" text-anchor=\"middle\" fill=\"#FFFFFF\" font-size=\"16\" font-weight=\"700\" letter-spacing=\"0.25\" font-family=\"'Proxima Soft', system-ui, sans-serif\">Next</text></svg></div><div class=\"demo-figma-panel\"><div class=\"demo-panel-section\"><div class=\"demo-panel-heading\">Properties</div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">Text</span><select class=\"demo-panel-select\" id=\"tt-demo-text\" onchange=\"updateTooltipDemo()\"><option value=\"header\">Header</option><option value=\"description\">Description</option><option value=\"both\" selected=\"\">Both</option></select></div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">Placement</span><select class=\"demo-panel-select\" id=\"tt-demo-placement\" onchange=\"updateTooltipDemo()\"><option value=\"top\" selected=\"\">Top</option><option value=\"bottom\">Bottom</option><option value=\"left\">Left</option><option value=\"right\">Right</option></select></div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">Appearance</span><select class=\"demo-panel-select\" id=\"tt-demo-appearance\" onchange=\"updateTooltipDemo()\"><option value=\"opaque\" selected=\"\">Opaque</option><option value=\"translucent\">Translucent</option></select></div></div><div class=\"demo-panel-section\"><div class=\"demo-panel-heading\">Slots</div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">⤷ AssetSlot</span><select class=\"demo-panel-select\" id=\"tt-demo-asset\" onchange=\"updateTooltipDemo()\"><option value=\"on\" selected=\"\">Filled</option><option value=\"off\">Empty</option></select></div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">⤷ CloseSlot</span><select class=\"demo-panel-select\" id=\"tt-demo-close\" onchange=\"updateTooltipDemo()\"><option value=\"on\" selected=\"\">Filled</option><option value=\"off\">Empty</option></select></div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">⤷ ActionSlot</span><select class=\"demo-panel-select\" id=\"tt-demo-action\" onchange=\"updateTooltipDemo()\"><option value=\"on\" selected=\"\">Filled</option><option value=\"off\">Empty</option></select></div></div><div class=\"demo-panel-section\"><div class=\"demo-panel-heading\">Computed</div><div class=\"demo-panel-row\"><span class=\"demo-panel-label\">Container height</span><span class=\"demo-panel-readout\" id=\"tt-demo-height\">122px</span></div></div></div></div>",
      "traits": [
        {
          "name": "Reusable",
          "rating": "pass",
