...
export const verticalVoucher: ComponentData = {
  "meta": {
    ...
    "verdict": {
      ...
      "text": "Vertical Voucher, Horizontal Voucher (<code>5121:4533</code>), and Voucher Card Horizontal (<code>5119:1786</code>) are three parallel records of the same component. Merge into a single <code>Voucher Card</code> with <code>orientation: vertical | horizontal</code>, <code>state: default | limited | expiring | used | expired</code> (borrowed from Voucher Card Horizontal), an image Slot that accepts Voucher Asset instances, and text slots for title / description / price / original price / validity. Drop the 8 booleans in favor of a single <code>assetSize: large | small</code> enum and a proper <code>badges: [Badge]</code> array."
    }
  },
  "overview": {
    "traits": [
