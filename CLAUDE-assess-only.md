# CLAUDE.md — GCash Design System Assessment (Read-Only Mode)
...
├── CLAUDE.md                      ← Full rulebook (includes Figma edit tools)
├── CLAUDE-assess-only.md          ← This file (read-only mode)
└── assessment-src/
