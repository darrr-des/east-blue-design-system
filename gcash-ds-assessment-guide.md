...
| C5 | Only collapsed and expanded states defined — missing pressed, disabled, and focused states | Accordion |
...
|---|---|---|---|---|---|
| Accordion | `16830:2025` | Fix | Needs Refinement | 🔁 Re-assessing | Fixed: C1, C2. Open: C5, C4, C7 |
<!-- @@PROGRESS_TABLE_END@@ -->
...
|---|---|---|---|
| Accordion | C5 | Add **pressed** and **disabled** variant states with semantic color tokens (e.g. `main/accordion/color/pressed/bg`). | Open |
